...
export default function FitOverlay({ attrs, foot }: { attrs: Attributes; foot: FootMeasurement }) {
  ...
  return (
    <section style={{ marginTop: 24 }}>
      ...
      <p style={hint}>
        Приблизительно, 2D (длина × ширина). Обхват (по подушечке), объём и подъём — по литературе
        главные факторы посадки — оверлей НЕ видит: две стопы одной длины и ширины могут сидеть
        по-разному. Колодки производителей закрыты, контур приблизительный.
      </p>
    </section>
  )
}
